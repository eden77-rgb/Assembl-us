...
document.querySelectorAll('pre code').forEach(block => {
    ...
    const operators = ['PUSH ', 'POP', 'CALL', 'RET'];
...
const exosConsignes = [
    `; Exercice 1\n; Empile la valeur 10 dans la pile avec PUSH puis dépile cette valeur dans EAX avec POP\n`,
    `; Exercice 2\n; Appelle une fonction ma_fonction depuis _start\npuis dans ma_fonction, sauvegarde EBP, puis restaure-le avant de retourner`,
    `; Exercice 3\n; Explique pourquoi POP ESP est une erreur et corrige-la pour manipuler la pile correctement.\n`
];
...
const exosSujet = [
    `; Exercice 1\n; Empile la valeur 10 dans la pile avec PUSH\n; puis dépile cette valeur dans EAX avec POP\n`,
    `; Exercice 2\n; Appelle une fonction ma_fonction depuis _start\n; puis dans ma_fonction, sauvegarde EBP, puis restaure-le avant de retourner`,
    `; Exercice 3\n; Explique pourquoi POP ESP est une erreur\n; corrige-la pour manipuler la pile correctement.\n`
];
