...
document.querySelectorAll('pre code').forEach(block => {
    ...
    const operators = ['JMP', 'JE', 'JZ', 'JNE', 'JNZ', 'JG', 'JL', 'JGE', 'JLE', 'JC', 'JNC', 'CMP'];
...
const exosConsignes = [
    `; Exercice 1\n; Utilise ECX pour faire une boucle de 4 itérations\n; Puis insère une instruction NOP dans la boucle\n`,
    `; Exercice 2\n; Compare EAX et EBX\n; Puis si EAX = EBX, saute à une étiquette appelée .ok`,
    `; Exercice 3\n; Trouve l'erreur dans "JMP EAX", corrige le saut vers une étiquette valide`
];
