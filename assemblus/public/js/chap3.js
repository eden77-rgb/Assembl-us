...
const exosConsignes = [
    `; Exercice 1\n; Stocke la valeur 100 dans une adresse mémoire, puis copie-la dans EAX\n`,
    `; Exercice 2\n; Mets 42 dans EBX, stocke sa valeur en mémoire, puis charge cette valeur dans EAX\n`,
    `; Exercice 3\n; Corrige l'erreur : MOV 10, EAX ; (on ne peut pas faire un transfert immédiat vers la mémoire)\n`
];
